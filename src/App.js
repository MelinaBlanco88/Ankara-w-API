          ...
          <BrowserRouter>
            ...
            <ScrollToTop>
              ...
              <Routes>
                ...
                <Route path="/propiedades/:id" element={<Details />} />
                <Route path="*" element={<Error404 />} />
              </Routes>

              <div className="baloonwhp">
                <a
                  href="https://wa.me/525515108737"
                  target="_blank"
                ...
                >
                  <img
                    ...
                    alt="whatsapp"
                  ></img>
                  {/* <svg   className="whtsimag" xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
